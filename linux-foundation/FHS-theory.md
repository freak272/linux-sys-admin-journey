...
important directories in the filesystem :
 1.  * /  root directory
 - it is the entry point for file access.
...
function :
stores configuration files that define how the system and services operate.
-this are usually :
* text files.
...
---------------------------------------------------
3. /bin
- contains essential user commands required for the system to function and operate.
