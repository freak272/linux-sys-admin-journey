...
---------------------------------------------------
3. /bin
/bin - contains essential user commands required for the system to function and operate.
...
----------------------------------------------------
4. /sbin
/sbin - contains essential system administration binaries used managing, reparing and controlling the system,
...
----------------------------------------------------
5. /var
/var - stores variable data, data that changes frequently while the system is running.
function :
stores dynamic, constantly changing data generated by the system and services.
this includes :
* logs.
* caches
* database
...
* spool files
role :
   * active storage - records everything the system is doing in real time.
   * runtime support for services, many services rely on /var to operate.

/var stores variable data such as logs, caches, and application data that change frequently during system operation.
